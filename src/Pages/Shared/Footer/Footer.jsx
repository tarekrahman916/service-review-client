...
const Footer = () => {
  return (
    <div>
      <footer class="p-4 bg-white sm:p-6 bg-gray-900 text-white">
        <div class="grid grid-cols-2 lg:grid-cols-4 justify-center  text-white">
          ...
          <div>
            ...
            <ul class=" text-gray-400">
              <li class="mb-4">
                <Link to="/" class="hover:underline" alt="">
                  Privacy Policy
                </Link>
              </li>
              <li>
          ...
          <div class="grid grid-cols-2 gap-8 sm:gap-6 sm:grid-cols-3 text-white"></div>
        </div>
        <hr class="my-6 border-gray-200 sm:mx-auto border-gray-700 lg:my-8" />
        <div class="sm:flex sm:items-center sm:justify-between lg:mx-10">
